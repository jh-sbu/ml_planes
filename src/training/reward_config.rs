...
pub struct OrbitRewardConfig {
    ...
    pub pitch_jerk_reward_scale: f32,
    pub pitch_jerk_reward_weight: f32,
    pub roll_jerk_reward_scale: f32,
    pub roll_jerk_reward_weight: f32,
    pub yaw_jerk_reward_scale: f32,
    pub yaw_jerk_reward_weight: f32,
...
impl OrbitRewardConfig {
    pub fn log_fields(&self) -> Vec<(&'static str, String)> {
        vec![
            ...
            (
                "pitch_jerk_reward_scale",
                self.pitch_jerk_reward_scale.to_string(),
            ),
            (
                "pitch_jerk_reward_weight",
                self.pitch_jerk_reward_weight.to_string(),
            ),
            (
                "roll_jerk_reward_scale",
                self.roll_jerk_reward_scale.to_string(),
            ),
            (
                "roll_jerk_reward_weight",
                self.roll_jerk_reward_weight.to_string(),
            ),
            (
                "yaw_jerk_reward_scale",
                self.yaw_jerk_reward_scale.to_string(),
            ),
            (
                "yaw_jerk_reward_weight",
                self.yaw_jerk_reward_weight.to_string(),
            ),
...
impl Default for OrbitRewardConfig {
    fn default() -> Self {
        Self {
            ...
            pitch_jerk_reward_scale: 100.0,
            pitch_jerk_reward_weight: 0.3,
            roll_jerk_reward_scale: 100.0,
            roll_jerk_reward_weight: 0.15,
            yaw_jerk_reward_scale: 100.0,
            yaw_jerk_reward_weight: 0.05,
            alive_reward: 0.01,
...
mod tests {
    ...
    fn orbit_log_fields_covers_all_fields() {
        ...
        assert!(fields.iter().any(|(k, _)| *k == "pitch_jerk_reward_scale"));
        assert!(fields.iter().any(|(k, _)| *k == "max_episode_steps"));
