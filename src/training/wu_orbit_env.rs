...
mod tests {
    ...
    fn set_rng_seed_is_history_independent() {
        let mut a = WuOrbitEnv::new(1000.0, 100.0, 1000.0, jet_cfg());
        let mut b = WuOrbitEnv::new(1000.0, 100.0, 1000.0, jet_cfg());
        a.reset();
        for _ in 0..5 {
            b.reset();
        }
    ...
    fn offset_rng_seed_stays_additive_over_set_rng_seed() {
        ...
        let mut direct = WuOrbitEnv::new(1000.0, 100.0, 1000.0, jet_cfg());
